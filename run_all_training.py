...
REPOSITORY="Anurag9000/CO-project"; CONTROLLER_COMMIT="257c82a9686d5aeeee765c1ca5d8df168f80129e"; CONTROLLER_BLOB="a164fd06fc2800cd92243a394f2582d0617f814d"; SOURCE=f"https://raw.githubusercontent.com/Anurag9000/RigorousRAG/{CONTROLLER_COMMIT}/tools/universal_training_controller_entry.py"; ROOT=Path(__file__).resolve().parent
