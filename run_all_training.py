...
REPOSITORY="Anurag9000/CO-project"; CONTROLLER_COMMIT="8080f8c8e55d802d4220bcc1c9b62a4f2e2ce052"; CONTROLLER_BLOB="a739ff9e31d9be7b5c9b0fe8d9bcfca6d75c846b"; SOURCE=f"https://raw.githubusercontent.com/Anurag9000/RigorousRAG/{CONTROLLER_COMMIT}/tools/universal_training_controller_entry.py"; ROOT=Path(__file__).resolve().parent
